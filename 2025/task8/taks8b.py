...
from dulwich.porcelain import branch_list
...
def closest_point(coords, i):
    ...
    if closest_dist != MAX:
        ...
        global last_c1, last_c2
        last_c1 = coords[closest_point1_idx]
        last_c2 = coords[closest_point2_idx]
        return coords[closest_point1_idx], coords[closest_point2_idx], closest_point
...
def main():
    ...
    iter = 0
    closest_point(coords, iter)

    while True:
        closest_point(coords, iter)
        iter+=1
        if count_circuts(coords) == 1:
            print("done")
            break
    ...
    print(last_c1)
    print(last_c2)
    print("Result: " + str(last_c1[0] * last_c2[0]))
